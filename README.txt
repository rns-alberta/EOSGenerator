...
the Polytropes.pdf. To run the code you need the [eosNV, eosBPS, eosFPS] files and the Polytropes.cpp.
...
the Greif.pdf. To run the code you need the [eosNV, eosBPS, eosFPS] files, the [eoscEFTstiff or eoscEFTsoft] files and the grif.cpp.
